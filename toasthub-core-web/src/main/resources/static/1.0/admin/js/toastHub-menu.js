...
ToastHubMenu.prototype = Object.create(toastHubBase.prototype);
ToastHubMenu.prototype.constructor = ToastHubMenu;

function ToastHubMenu(instanceName,parent){
	toastHubBase.call(this,instanceName,this);
	this.ajaxFunc = "admin";
	this.service = "MENU_SVC";
	this.category = "ADMIN";
	this.menus = null;
	...
	this.initCustom = function(params){
		toastHub.logSystem.log("DEBUG","toastHub-menu::ToastHubMenu::initCustom");
	...
	this.listCustom = function(params){
		toastHub.logSystem.log("DEBUG","toastHub-menu::ToastHubMenu::listCustom");
		params.category = this.category;
	}; // listCustom
	
	this.initContent = function(params) {
		toastHub.logSystem.log("DEBUG","toastHub-menu::ToastHubMenu::initContent");
	...
	this.processList = function(params){
		toastHub.logSystem.log("DEBUG","toastHub-menu::ToastHubMenu::processList");
	...
	this.listItemOpen = function(event){
		toastHub.logSystem.log("DEBUG","toastHub-menu::toastHubMenu::listItemOpen");
	...
	this.menuListCallBack = function(JSONData) {
		toastHub.logSystem.log("DEBUG","toastHub-menu::toastHubMenu::menuListCallBack");
	...
	this.menuItemsListCallBack = function(JSONData) {
		toastHub.logSystem.log("DEBUG","toastHub-menu::toastHubMenu::menuItemListCallBack");
	...
	this.openMenuModal = function(params) {
		toastHub.logSystem.log("DEBUG","toastHub-menu::toastHubMenu::openMenuModal::"+params.title);
	...
	this.openMenuItemModal = function(params) {
		toastHub.logSystem.log("DEBUG","toastHub-menu::toastHubMenu::openMenuItemModal::"+params.title);
